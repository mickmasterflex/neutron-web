<template>
  <status-bar :show="show" icon="info-circle" color="blue" enter-active-class="animate__animated animate__fadeIn">
    <template slot="content">
      ...
      <router-link
        ...
        :to="{ name: 'BuyerContract', params: { id: contract.contract_id, client: currentClientData.slug } }">{{ contract.contract_name }}</router-link>
    </template>
  </status-bar>
</template>
