<template>
  <div>
    <div class="flex flex-row justify-between items-center mb-5">
      <h4 class="h3" >
        <span v-if="$route.name === 'BuyerContractFPI'">FPI</span>
      ...
      <router-link v-if="$route.name === 'BuyerContractFPI'"
                   ...
                   class="btn btn-hollow-blue"><font-awesome-icon icon="arrow-left"></font-awesome-icon> Field Management</router-link>
