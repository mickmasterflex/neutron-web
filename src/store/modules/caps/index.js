...
const getters = {
  ...
  getShowCapsParentModal: state => (state.show_caps_parent_modal)
}
...
const mutations = {
  ...
  SHOW_CAPS_PARENT_MODAL: (state) => (state.show_caps_parent_modal = true),
  CLOSE_CAPS_PARENT_MODAL: (state) => (state.show_caps_parent_modal = false)
}
